...
echo $yellow
figlet -f future "GHOST ARMY CYBER"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo
echo $indigo"      +"$cyan"{"$white"I"$cyan"}"$green"Info"$indigo"     +"$cyan"{"$white"Q"$cyan"}"$green"Quit"$cyan
echo $cyan"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo $indigo"=============================================================="
echo
echo $pink "╭─"$yellow"GHOST ARMY CYBER "$cyan" ~ MAKER SCRIPT BY MR.T"$blue
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"GHOST ARMY CYBER"$cyan" ~/MAKER BY MR.T"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"GHOST ARMY CYBER"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"GHOST ARMY CYBER"$cyan" ~/Crot"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"GHOST ARMY CYBER" ~/Crot"$white
read -p " ╰─$ " target6
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : MR.T		"
echo $purple"Gthub   : github.com/BURIQ2019"
echo $red"B/Q  EROR"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] GHOST ARMY CYBER "
echo $red"##########################$green" WELCOME "$red###########################"
